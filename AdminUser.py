...
<head>
	...
	<link rel="stylesheet" type="text/css" href="estilo/cssPerfil.css"/>
...
<body>
    ...
    <div>
        ...
        <div class="menu">
        	...
        	<a href="duvidas.html"><button class="button" style="padding: 10px; position: absolute; left: 92.5%; top: 13.4%;">Dúvidas</button></a>
        <div class="search">
...
<div id="main">
    <article>
    	<div class="dest">
    		<h1 class="textdest">Meus produtos</h1>
        </div>
            '''
        html += self.ProdsUser()
        html += '''
    ...
    def ProdsUser(self):
        ...
        cur = con.cursor()
        cur.execute(
            'Select ProdCod, Nome, Foto, Vendedor from Produtos')
        ...
        tnome = arq.read()
        arq.close()
        sql = "Select UserCod from Usuarios where Nome = '%s'" % tnome
        cur.execute(sql)
        dados2 = cur.fetchall()
        for produtos in dados:
            if(str(produtos[3]) == str(dados2[0][0])):
                if z == 1:
                    y = 5
                elif z == 5:
                    z = 1
                    ...
                    y = 5
                html += '''
                    <div class="edproduto" style="top: %d%%; left: %d%%;">
                    <a href="/AltProd/"><img src="%s" width="200px;" height="200px; class="imgProd"></a>
                    <p class="titleprod">%s</p>
                    <a href="/AltProd/"><button class="button">Editar produto</button></a>
                </div>''' % (x, y, produtos[2], produtos[1])
                y += 24
                z += 1
        html += '''<div class="produto" style="top: %d%%; left: %d%%;">
                    <a href="/CadProd/"><img src="https://uploaddeimagens.com.br/images/002/988/809/original/Adicionar.png?1607021700" width="240px;" class="imgProd"></a>
                    <p class="prec">Adicionar produto</p>
				</div>''' %(x,y)
        return html
    ...
    cherrypy.config.update(config=local_config)
