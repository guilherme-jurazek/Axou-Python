...
<body>
  <header>
  	...
  	<div>	
  		<div>
  			<h1 style="position: absolute; top: 40%; left: 24%; font-size: 25px; font-family: Arial; color: #00C22A; text-align: center;">MENSAGEM ENVIADA COM SUCESSO!<br> VOCÊ RECEBERÁ NOTIFICAÇÃO CASO SEJA RESPONDIDO!</h1>
   		</div>
