...
<body>
    ...
    <div>
        ...
        <div class="menu">
        	...
        	<a href="..\index.html"><button class="button" style="padding: 10px; position: absolute; left: 93.9%; top: 6%; border-radius: 35%;">SAIR</button></a>
...
<div id="main">
    <article>
    	...
    	<div class="dest">
    		<h1 class="textdest" style="left: 33%;">Dúvidas Frequentes</h1>
        </div>
        ...
        <div style="text-align: center;">
	    	...
	    	<div style="margin-top: 30px;">
                ...
                <a href="Resp1.html"><button class="button" style="font-size: 20px;">Como faço para meu produto entrar na aba "Destaque"?</button></a>

            </div>

            <div style="margin-top: 15px;">
       
            	<a href="Resp2.html"><button class="button" style="font-size: 20px;">Como edito meu perfil?</button>

			</div>

			<div style="margin-top: 15px;">
       
            	<a href="Resp3.html"><button class="button" style="font-size: 20px;">Como faço para enviar uma mensagem ao vendedor?</button></a>

			</div>
			<div style="margin-top: 15px;">
       
            	<a href="Resp4.html"><button class="button" style="font-size: 20px;">Quero começar a vender, tenho alguma taxa?</button></a>

			</div>
			<div style="margin-top: 15px;">
       
            	<a href="Resp5.html"><button class="button" style="font-size: 20px;">Coloquei meu produto em uma categoria errada o que eu faço?</button></a>

			</div>
			<div style="margin-top: 15px;">
       
            	<a href="Resp6.html"><button class="button" style="font-size: 20px;">É necessário CNPJ para começar a vender?</button></a>

			</div>
			<div style="margin-top: 30px;">
       
            	<a href="contato.html"><button class="button" style="font-size: 20px;">Outra dúvida? Clique aqui!</button></a>
