...
<body>
  ...
  <div id="main">
    <article>
    	<div class="dest">
    		<h1 class="textdest" style="left: 44.6%;">BUSCA</h1>
    	</div>
    	<div style="margin: 24px 28px; font-family: Arial; text-decoration: underline;">
	    	<h2>Não foi encontrado nenhum item com esse nome.</h2>
