...
<body>
    <header>
    <div>
        <a href=""><img src="https://uploaddeimagens.com.br/images/002/977/642/full/logo.png?1606241516" alt="Logo da empresa Axou." width="120" style="margin-top: 0%; cursor: pointer; left: 7%; position: absolute;"></a>

        <div class="menu">
            <a href=""><button class="button">MEUS PRODUTOS</button></a>
...
<div id="main">
    <article>
    	<div class="dest">
    		<h1 class="textdest">Perfil do Usuario</h1>
        </div>
        &nbsp&nbsp
        <div class="imgProd">
            <img src="https://uploaddeimagens.com.br/images/002/988/761/thumb/fotorosto.png?1607020259" alt="fotousuario" class="borda" style="width:150px;"/>
            <br/>
        </div>'''
        html += self.visu_perf()
        html += '''
    ...
    def visu_perf(self):
        ...
        cur = con.cursor()
        tnome = 'Guilherme Jurazek'
        sql = "Select * from Usuarios where Nome = '%s'" % tnome
        cur.execute(sql)
        dados = cur.fetchall()
        html = '''<div class="posinfo">
